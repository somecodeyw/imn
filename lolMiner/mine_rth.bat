...
:W10
"%MyVariable%" --algo ETHASHB3 --pool !POOL! --user !WALLET!  !EXTRAPARAMETERS! --watchdog exit
timeout 10
goto W10
goto END

:OtherW
"%MyVariable%" --algo ETHASHB3 --pool !POOL! --user !WALLET!  !EXTRAPARAMETERS! --watchdog exit --nocolor
timeout 10
goto OtherW
